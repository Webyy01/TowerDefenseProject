...
//Function for tower to shoot a bullet
void Tower::shoot(){
    ...
    if(closestEnemy){
        ...
        Bullet* bullet = new Bullet(map, position, Damage, closestEnemy); //create a new bullet with the specified map, position, damage, and enemy
